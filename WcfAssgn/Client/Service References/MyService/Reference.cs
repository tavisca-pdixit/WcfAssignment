...
namespace Client.MyService {
    ...
    public interface ICreateEmployeeDetails {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICreateEmployeeDetails/Search", ReplyAction="http://tempuri.org/ICreateEmployeeDetails/SearchResponse")]
        Client.MyService.EmployeeData Search(string empId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICreateEmployeeDetails/Search", ReplyAction="http://tempuri.org/ICreateEmployeeDetails/SearchResponse")]
        System.Threading.Tasks.Task<Client.MyService.EmployeeData> SearchAsync(string empId);
    }
    ...
    public partial class CreateEmployeeDetailsClient : System.ServiceModel.ClientBase<Client.MyService.ICreateEmployeeDetails>, Client.MyService.ICreateEmployeeDetails {
        ...
        public Client.MyService.EmployeeData Search(string empId) {
            return base.Channel.Search(empId);
        }
        
        public System.Threading.Tasks.Task<Client.MyService.EmployeeData> SearchAsync(string empId) {
            return base.Channel.SearchAsync(empId);
        }
    }
}
